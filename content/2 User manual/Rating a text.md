...
There are different ways to set the rating, depending on what page you are looking at.  

## Rating a text from [[the textview page]]

![[textview.png]]
The rectangular area labelled with (1) in the above screenshot is the menu bar, which gives access to various functions of the system.  The item immediately to the right of the [[Blue Eye]]  gives the source of the text (CHANT in this case). That area can also be clicked at and reveals [[information about the text]].  An example (of a different text) is given in the following screen shot (<a href="https://hxwd.org/textview.html?location=CH1c0887_CHANT_052-1a.1-h&prec=0&foll=30" target="hxwd">Visit this page on HWXD</a>):
...
[^2]: You will need to reload the page to populate the menu after a change.
