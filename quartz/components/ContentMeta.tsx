...
//      const segments: (string | JSX.Element)[] = []
      ...
      return (
        <p class={classNames(displayClass, "content-meta")}>
          ...
          🌟 <a href={`https://github.com/tls-kr/hxwd-docs/blame/v4/${fileRelativePath}`} class={classNames(displayClass, "external")} target={"_blank"} style={"font-weight:400"}>
          ...
          🗓️ <a href={`https://github.com/tls-kr/hxwd-docs/commits/v4/${fileRelativePath}`} class={classNames(displayClass, "external")} target={"_blank"} style={"font-weight:400"}>
